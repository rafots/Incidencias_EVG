...
require_once '../procedimientos/procedimientos.php';
        ...
        $objeto->conectar();
        $consulta="Select tipos_anotaciones.tipoAnotacion as tipoAnotaciones,tipos_anotaciones.nombre as nombre,anotaciones.nia as 'Nia del alumno',nombreCompleto, numAnotacion,substring(hora_Registro,1,11)as fecha,descripcion,alumnos.idSeccion,profesores_seccion.idSeccion from (SELECT * FROM anotaciones LIMIT 10)
