...
function visualizar($objeto){
    ...
    while($fila=$objeto->devolverFilas()){
        ...
        echo '<br/>';
        echo '<a href="eliminaranotaciones.php?numAnotacion='.$fila["numAnotacion"].'" class="btn btn-success" role="button">Eliminar</a> ';
        echo '<a href="modificaranotaciones.php?numAnotacion='.$fila["numAnotacion"].'" class="btn btn-success" role="button">Modificar</a> ';
        echo '<a href="misanotaciones.php" class="btn btn-success " role="button">Volver</a> ';
