            ...
            <?php
                ...
                if($fila_tabla=$resultado_tabla->fetch_array())
                {
                    while($fila_tabla=$resultado_tabla->fetch_array())
                    {
                        ...
                        echo '<td><a href="?modificar=si&nombreAntiguo='.$fila_tabla["nombre"].'">Modificar</a></td>';
                        echo '</tr>';
                    }
                }
                else
                ...
                {
                    echo '<form method="get" action="alterTipoInc.php?nombreTipo='.$fila_tabla["nombre"].'&nombreAntiguo='.$_GET["nombreAntiguo"].'">';
                    echo '<label>Nuevo nombre: </label>';
                    echo '<input type="text" name="nombreTipo"/>';
                ...
                {
                    $consulta_modificar="UPDATE tipo_incidencias SET nombre='".$_GET["nombreTipo"]." WHERE nombre='".$_GET["nombreAntiguo"]."''";
                    $resultado_modificar=$conectar->query($consulta_modificar);
                    echo '<p>Se ha modificado con exito</p>';
                }
            ?>
        </article>
    </div>
